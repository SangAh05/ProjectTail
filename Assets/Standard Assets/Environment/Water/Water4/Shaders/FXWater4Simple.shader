...
CGINCLUDE
	...
	half4 frag( v2f i ) : SV_Target
	{
		...
		// Refraction disabled - GrabPass not supported in URP
		// Using base color instead of refraction
		half4 rtRefractions = _BaseColor;
		half4 rtRefractionsNoDistort = _BaseColor;
...
Subshader
{
	...
	// GrabPass removed - not supported in URP
